...
public class Mountain extends Fractal {
    ...
    private void fractalMount(TurtleGraphics turtle, int order, int divader, int reverse, Point start_point, Point a_Point, Point b_Point, Point c_Point, double dev) {
        ...
        if (order == 0) {
            ...
            fractalMount(turtle, order-1, divader*2, reverse+ 180,  midPoint(b_Point, c_Point, 0), midPoint(b_Point, c_Point, 0), midPoint(a_Point, b_Point, 0), midPoint(a_Point, c_Point, 0), dev/2);
