...
public class Mountain extends Fractal {
    ...
    private Point p3;
    private double dev;
    private Side remov_this_side;
    //private Side used_side;
    ...
    */
    ...
    private Point midPoint (Point p1, Point p2, int maount_val) {
        ...
        Side side_same = new Side(p1, p2);
        
        
        if (voide_clenser.containsKey(side_same)){
            Point output =             voide_clenser.get(side_same);
            voide_clenser.remove(remov_this_side);
            remov_this_side =side_same;
            return output;
        }
