...
public class TestSolver {
  ...
  @Test
  public void testIligalInputs() {
    assertThrows(IndexOutOfBoundsException.class, () -> solver.set(4, 4, -1), "-1 is wrong input");
    assertThrows(IndexOutOfBoundsException.class, () -> solver.set(4, 4, 0), "0 is wrong input");
    assertThrows(IndexOutOfBoundsException.class, () -> solver.set(4, 4, 10), "10 is wrong input");
    //assertThrows(IndexOutOfBoundsException.class, () -> solver.set(4, 4, "a"), "a is wrong input");
  }
  ...
  public void testSolveReturnsFalseOnRuleBreakingSudoku() {
    ...
    solver.clearAll();
    assertTrue(solver.solve(), "Solver::solve should solv claeard sudokus");
  }
