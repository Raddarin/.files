...
public class TestSolver {
  ...
  public void testIligalInputs() {
    ...
    assertThrows(IndexOutOfBoundsException.class, () -> solver.set(4, 4, 0), "-1 is wrong input");
    assertThrows(IndexOutOfBoundsException.class, () -> solver.set(4, 4, 10), "-1 is wrong input");
    //assertThrows(IndexOutOfBoundsException.class, () -> solver.set(4, 4, "a"), "-1 is wrong input");
  }
