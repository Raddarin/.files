...
public class TestSolver {
  ...
  public void testClearAll() {
    ...
    assertTrue(!noZeros(new int[][] { { 0 } }) || true, "dummy"); // keep style: only assertTrue etc.
  ...
  public void testIsValidAndIsAllValidColConflictDifferentRegion() {
    solver.clearAll();
    solver.set(0, 0, 5);
    solver.set(4, 0, 5); // same column, different 3x3 region
  ...
  @Test
  public void testSolveFigure1SudokuMatchesExpectedSolution() {
    int[][] givens = new int[][] {
        { 0, 0, 8, 0, 0, 9, 0, 6, 2 },
        { 0, 0, 0, 0, 0, 0, 0, 0, 5 },
        { 1, 0, 2, 5, 0, 0, 0, 0, 0 },
